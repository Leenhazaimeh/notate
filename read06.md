...
hardest thing about programming is learning the problem domain.
Simply that by taking away the problem domain, or making it so trivial that it is easily understood,
...
# Chapter 3: “Object Literals” (pp.100-105)
  ...
  Object :a set of variables and functions to create a model 
 If a variable is part of an object, it is called a 
property,,If a function is part of an object, it is called a method. 

![](https://d2h0cx97tjks2p.cloudfront.net/blogs/wp-content/uploads/sites/2/2019/07/How-to-Create-JavaScript-Objects.jpg")
...
how JavaScript can access and update the 
...
The model is called a DOM tree, and it is stored in the browsers' memory,
 document node is added; it 
represents the entire page (and also corresponds to 
the document object ,to access the DOM tree, you start by looking for 
